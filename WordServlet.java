...
public class  WordServlet extends jakarta.servlet.http.HttpServlet
{
	protected void service (jakarta.servlet.http.HttpServletRequest req,jakarta.servlet.http.HttpServletResponse res)throws jakarta.servlet.ServletException, java.io.IOException
	{
		...
		pw.println("<table align='center' cellspacing=5px cellpadding=25px  border=1 width=500px height=300px bgcolor='yellow'>");
